        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light" style={{ paddingBottom: 0, paddingTop: 0 }}>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <span className="nav-link span-link" onClick={props.onClearClick}>Clear All Storage &nbsp;<i className="fas fa-exclamation-triangle"/>
                        </span>
                    </li>

                    <li className="nav-item">
                        <span className="nav-link span-link" onClick={props.onRefreshClick}>Refresh App State &nbsp;<i className="fas fa-redo-alt"/>
                        </span>
                    </li>
